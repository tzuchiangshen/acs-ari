...
if not _M_ROACHControl.__dict__.has_key('ROACH'):
    _M_ROACHControl.ROACH = Ice.createTempClass()
    class ROACH(Ice.Object):
        def __init__(self):
            if __builtin__.type(self) == _M_ROACHControl.ROACH:
    ...
    _M_ROACHControl._t_ROACH = IcePy.defineClass('::ROACHControl::ROACH', ROACH, (), True, None, (), ())
    ROACH._ice_type = _M_ROACHControl._t_ROACH

    ROACH._op_message = IcePy.Operation('message', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), IcePy._t_string),), (((), IcePy._t_string),), None, ())
